...
class Ticker(MarketBase):
    ...
    def get_bookTickers(self) -> dict:
        ...
        '''
        return self.inst.market.get_ticker_bookTicker()
    ...
    def get_bookTicker(self, symbol: str) -> dict:
        ...
        :param symbol: 产品
        '''
        return self.inst.market.get_ticker_bookTicker(symbol=symbol)
    ...
    def get_tickerPrices(self):
        ...
        '''
        return self.inst.market.get_ticker_price(symbol='')
